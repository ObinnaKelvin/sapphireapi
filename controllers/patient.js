...
export const createPatient = async (req, res) => {
    ...
    try {
        ...
        const newPatient = new Patient({
            ...
            emr_maidenname: req.body.emr_maidenname,
            emr_gender:  req.body.emr_gender,
            emr_tel:  req.body.emr_tel,
            emr_birthplace:  req.body.emr_birthplace,
            emr_occupation:  req.body.emr_occupation,
            emr_workplace:  req.body.emr_workplace,
            emr_kinOccupation:  req.body.emr_kinOccupation,
            emr_stateCode:  req.body.emr_stateCode,
            emr_nationalityId:  req.body.emr_nationalityId,
            emr_religionId:  req.body.emr_religionId,
