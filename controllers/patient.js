...
export const createPatient = async (req, res) => {
    ...
    try {
        ...
        const newPatient = new Patient({
            ...
            emr_maidenname: req.body.emrmaidenname,
            emr_gender:  req.body.emrgender,
            emr_tel:  req.body.emrtel,
            emr_birthplace:  req.body.emrbirthplace,
            emr_occupation:  req.body.emroccupation,
            emr_workplace:  req.body.emrworkplace,
            emr_kinOccupation:  req.body.emrkinOccupation,
            emr_stateCode:  req.body.emrstateCode,
            emr_nationalityId:  req.body.emrnationalityId,
            emr_religionId:  req.body.emrreligionId,
