...
export const createPatient = async (req, res) => {
    ...
    try {
        ...
        const newPatient = new Patient({
            ...
            emrmaidenname: req.body.emr_maidenname,
            emrgender:  req.body.emr_gender,
            emrtel:  req.body.emr_tel,
            emrbirthplace:  req.body.emr_birthplace,
            emroccupation:  req.body.emr_occupation,
            emrworkplace:  req.body.emr_workplace,
            emrkinOccupation:  req.body.emr_kinOccupation,
            emrstateCode:  req.body.emr_stateCode,
            emrnationalityId:  req.body.emr_nationalityId,
            emrreligionId:  req.body.emr_religionId,
